...
const FEATURES: { icon: keyof typeof Ionicons.glyphMap; title: string; desc: string }[] = [
  {
    ...
    desc: 'Full stories behind every site, written by local historians.',
  },
  {
    icon: 'headset-outline',
    title: 'Audio Guides',
    desc: 'Narrated tours you can listen to on site or at home.',
  },
  {
    icon: 'cube-outline',
    title: '3D & VR Tours',
    desc: 'Explore destinations immersively before you travel.',
  },
  {
    icon: 'download-outline',
    title: 'Offline Access',
    desc: 'Download sites and maps for travel without signal.',
  },
  {
    icon: 'pricetag-outline',
    title: 'Member Discounts',
    desc: 'Save on guides and partner hotels across Ghana.',
  },
];
